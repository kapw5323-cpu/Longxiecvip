--[[ 
    MENU LONG XIẾC VIP V160 - 360° AIM LOCK
    - Link: https://raw.githubusercontent.com/kapw5323-cpu/Longxiecvip/main/Longxiecvip.lua
    - Tính năng: Quét mục tiêu 360 độ, Ghim đầu siêu dính, ESP Color Fixed.
]]

local LP = game:GetService("Players").LocalPlayer
local Cam = workspace.CurrentCamera
local UI_NAME = "LX_VIP_V160"

if LP.PlayerGui:FindFirstChild(UI_NAME) then LP.PlayerGui[UI_NAME]:Destroy() end

local Sets = { 
    AimPlr = false, AimNPC = false, ESP = false, 
    Wall = false, Speed = false, Fov = 300 -- Tăng FOV để quét rộng hơn
}
...
local Title = Instance.new("TextLabel", Main); Title.Size = UDim2.new(1,0,0,35); Title.Text = "MENU LONG XIẾC VIP V160 (360°)"; Title.TextColor3 = Color3.new(1,1,1); Title.BackgroundColor3 = Color3.new(0.3, 0, 0); Title.Font = Enum.Font.SourceSansBold
...
AddBtn("KÍCH HOẠT ESP 👁️", "ESP", UDim2.new(0.05,0,0.1,0), Color3.new(0,1,0))
AddBtn("GHIM ĐẦU 360° (BLUE)", "AimPlr", UDim2.new(0.05,0,0.23,0), Color3.new(0,0.5,1))
AddBtn("GHIM ĐẦU NPC (RED)", "AimNPC", UDim2.new(0.05,0,0.36,0), Color3.new(1,0,0))
AddBtn("CHECK TƯỜNG (FIXED)", "Wall", UDim2.new(0.05,0,0.49,0), Color3.new(1,1,0))
AddBtn("SIÊU CHẠY NHANH ⚡", "Speed", UDim2.new(0.05,0,0.62,0), Color3.new(1,0.5,0))
